...
!(function (t, e) {
  ...
  var e = (function () {
    ...
    function J(t, r, i) {
      for (n in r)
        i && (Z(r[n]) || L(r[n]))
          ? (Z(r[n]) && !Z(t[n]) && (t[n] = {}), L(r[n]) && !L(t[n]) && (t[n] = []), J(t[n], r[n], i))
          : r[n] !== e && (t[n] = r[n]);
    }
    function W(t, e) {
    ...
    function Q(t) {
      try {
        return t
          ? 'true' == t ||
              ('false' == t ? !1 : 'null' == t ? null : +t + '' == t ? +t : /^[\[\{]/.test(t) ? r.parseJSON(t) : t)
          : t;
      } catch (e) {
        return t;
      }
      ...
      ((h.href = t.location.href),
        ...
        (e.ajax = function (n) {
          ...
          if (
            ...
            return (
              p || (s.url = T(s.url, s.jsonp ? s.jsonp + '=?' : s.jsonp === !1 ? '' : 'callback=?')),
              e.ajaxJSONP(s, a)
            );
          var P,
            d = s.accepts[c],
          ...
          if (
            ...
            b('Accept', d || '*/*'),
            (d = s.mimeType || d) &&
              (d.indexOf(',') > -1 && (d = d.split(',', 2)[0]), N.overrideMimeType && N.overrideMimeType(d)),
